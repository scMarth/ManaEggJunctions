...
def update_junction_parent_costs(junction):
    ...
    while True:
        ...
        if curr_junction.left_child_egg.min_cost != -1 and curr_junction.right_child_egg.min_cost != -1:
            if curr_junction.min_cost == -1 or curr_junction.min_cost > curr_junction.left_child_egg.min_cost + curr_junction.right_child_egg.min_cost:
...
def update_egg_parent_costs(egg):
    ...
    while True:
        ...
        if parent_junction.left_child_egg.min_cost != -1 and parent_junction.right_child_egg.min_cost != -1:
            if parent_junction.min_cost == -1 or parent_junction.min_cost > parent_junction.left_child_egg.min_cost + parent_junction.right_child_egg.min_cost:
