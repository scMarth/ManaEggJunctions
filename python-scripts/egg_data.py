...
egg_levels = [
   ["Dust"],                                                                        # Level 0
   ["Flare", "Aqua", "Wind", "Stone"],                                              # Level 1
   ["Lava", "Heat", "Sand", "Mist"],                                                # Level 2
   ["Thunder", "Frost", "Leaf", "Bomb", "Burst"],                                   # Level 3
   ["Forest", "Booster", "Decrease", "Darkness", "Star", "Lightning", "Icicle"],    # Level 4
   ["Volcano", "Cyclone", "Rainbow", "Gravity", "Fairy"],                           # Level 5
   ["Cluster", "Photon", "Blizzard", "Soul", "Restore"],                            # Level 6
   ["Life", "Astral", "Protect", "Void"],                                           # Level 7
   ["Crown", "Calamity", "Dragon", "Fenrir"],                                       # Level 8
   ["Chaos", "Ether", "Holy"]                                                       # Level 9
]
